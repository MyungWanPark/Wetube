...
로그인 페이지 입니다. 세션을 활용하여 세션ID로 유저를 판독합니다. 깃허브아이디로 로그인 할 수 있도록 소셜 로그인 기능도 구현하였습니다. 
...
로그인 한 뒤의 웹사이트 모습입니다. 비디오 업로드, 프로필 수정과 같이 권한이 있는 유저에게만 기능을 보여주었습니다. 
...
프로필 정보를 수정하는 페이지 입니다. 로그인 한 유저 정보를 가지고 와서 정보를 수정하여 다시 MongoDB로 저장합니다. 
...
비디오 플레이어를 WebAPIs를 활용하여 직접 제작하였고, 해당 비디오에 댓글의 추가 삭제 기능을 구현하였습니다. 
